...
class Interceptor extends \Magento\QuoteGraphQl\Model\Resolver\SetPaymentAndPlaceOrder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\QuoteGraphQl\Model\Cart\GetCartForUser $getCartForUser, \Magento\QuoteGraphQl\Model\Cart\SetPaymentAndPlaceOrder $setPaymentAndPlaceOrder, \Magento\Sales\Api\OrderRepositoryInterface $orderRepository)
    {
        $this->___init();
        parent::__construct($getCartForUser, $setPaymentAndPlaceOrder, $orderRepository);
    }
